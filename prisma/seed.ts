  ...
  const templates = await Promise.all([
    prisma.deliveryTemplate.upsert({
      ...
      create: {
        ...
        commandTemplate: 'lp user {player_name} parent set {delivery_key}',
        isActive: true,
      },
    }),
    prisma.deliveryTemplate.upsert({
      ...
      create: {
        ...
        commandTemplate: 'give {player_name} {delivery_key} {delivery_amount}',
        isActive: true,
      },
    }),
    prisma.deliveryTemplate.upsert({
      ...
      create: {
        ...
        commandTemplate: 'crates give {player_name} {delivery_key} {delivery_amount}',
        isActive: true,
      },
    }),
    prisma.deliveryTemplate.upsert({
      ...
      create: {
        ...
        commandTemplate: 'eco give {player_name} {delivery_amount}',
        isActive: true,
      },
    }),
    prisma.deliveryTemplate.upsert({
      ...
      create: {
        ...
        commandTemplate: 'lp user {player_name} permission set {delivery_key} true',
        isActive: true,
      },
    }),
    prisma.deliveryTemplate.upsert({
      ...
      create: {
        ...
        commandTemplate: 'cosmetics unlock {player_name} {delivery_key}',
        isActive: true,
      },
    }),
  ]);
